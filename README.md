...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `557.7µs` | `782.1µs` |
| [Day 2](./src/bin/02.rs) | `400.8µs` | `400.5µs` |
| [Day 3](./src/bin/03.rs) | `259.5µs` | `179.6µs` |
| [Day 4](./src/bin/04.rs) | `674.0µs` | `678.8µs` |
| [Day 5](./src/bin/05.rs) | `129.4µs` | `654.2µs` |
| [Day 6](./src/bin/06.rs) | `1.8µs` | `719.0ns` |
| [Day 7](./src/bin/07.rs) | `423.5µs` | `444.7µs` |
| [Day 8](./src/bin/08.rs) | `791.5µs` | `3.3ms` |
| [Day 9](./src/bin/09.rs) | `249.7µs` | `248.8µs` |
| [Day 10](./src/bin/10.rs) | `418.9µs` | `599.6µs` |
| [Day 11](./src/bin/11.rs) | `2.7ms` | `2.7ms` |
| [Day 12](./src/bin/12.rs) | `457.6µs` | `1.1ms` |
| [Day 13](./src/bin/13.rs) | `220.1µs` | `1.7ms` |
| [Day 14](./src/bin/14.rs) | `43.2µs` | `49.9ms` |
| [Day 15](./src/bin/15.rs) | `70.7µs` | `1.4ms` |
| [Day 16](./src/bin/16.rs) | `689.0µs` | `30.0ms` |
| [Day 17](./src/bin/17.rs) | `32.0ms` | `103.2ms` |
